<div class="maintop">
	...
	<div class="box half">
		<div class="cont">
			...
			<p>The Bevo Ad Exchange is the first ad buying platform that allows advertisers to buy both affiliate traffic and display traffic on one platform. As an advertiser, you have the ability to bid on individual affiliates as a traffic source, and have your product instantly rotate into each affiliate's campaign instantly. From the same interface, you can also buy conventional display and retargeting traffic from hundreds of thousands high-traffic websites.</p>
