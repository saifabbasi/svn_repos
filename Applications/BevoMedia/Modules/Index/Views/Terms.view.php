...
<h3>1. Enrollment in the Affiliate Program</h3>
...
<h3>2. Affiliate Requirements</h3>
...
<h3>3. Obligations of the Parties</h3>
...
<h3>Cancelation Procedure:</h3>

<p>
	In the event that you would like to cancel your product or service, please go to the My Products
	page within the Account information section or Click Here: http://beta.bevomedia.com/BevoMedia/User/MyProducts.html
</p>

<h3>Refund Policy:</h3>

<p>
	In the event that you are unsatisfied with our products or services, you may request a refund
	within thirty (30) days of payment, less all administrative, banking, and merchant fees. A refund
	may be requested via email at refunds@bevomedia.com or via phone at 1-888-644-BEVO. No
	refund will be issued after the 30 day period has passed for any reason. No partial refund will be
	issued for service interruption or failure.
</p>

<p>
	THE PPV SPY PRODUCT REFUND POLICY APPEARS BELOW. FOR ALL REFUND
	INQUIRES REGARDING THE PPV SPY PRODUCT, PLEASE REFER TO THE BELOW
	AND DISREGARD THE ABOVE STANDARD BEVO MEDIA REFUND POLICY.
</p>

<p>
	Services provided through the BeVo website are hosted by Amazon.com. BeVo Media makes
	no guarantee of server uptime and offers no partial refund for web hosting service disruption.
</p>

<p>
	BEVO MEDIA RESERVES THE RIGHT, IN ITS SOLE DISCRETION, TO CHANGE THE REFUND POLICY IN
	EFFECT, OR TO ADD NEW FEES AND/OR CHARGES, BY POSTING SUCH CHANGES ON THE WEBSITE OR
	OTHERWISE PROVIDING NOTICE TO YOU AS PROVIDED HEREIN.
</p>

<p>See the individual TOS for each respective product/service for details on its specific refund parameters.</p>

<p><u>PPV SPY REFUND POLICY:</u></p>

<p>
	By registering with the Website, You expressly authorize PPV Spy to charge you the then-current, one-
	time, upfront membership fee (the "Membership Fee") of $999, or the monthly recurring membership
	fee of $385 (at your election). In addition to the Membership Fee, You must be a verified BeVo Media
	member as described on the website, www.bevomedia.com.		
</p>

<p><u>Refund Policy if $999 Membership Fee is elected:</u></p>

<p>
	Membership Fees may be refunded within thirty (30) days of initial purchase, less bank/merchant fees.
	If the refund is requested within seven (7) days of initial purchase, a full refund will be granted. If a
	refund is requested between eight (8) and thirty (30) days of initial purchase, a partial refund will be
	granted pro rata by dividing the number of days since initial purchase by 30. No refund will be provided
	after 30 days if the up-front, $999 option was chosen.
</p>
...
<p>
	...
	refund is requested between eight (8) and thirty (30) days of initial purchase, a partial refund will be
	granted pro rata by dividing the number of days since initial purchase by 30. No refund will be provided
	for any payment 30 days after it has been made.
</p>
...
<p>
	...
	30. For example, if You chose the recurring membership fee of $385, and request a refund on the 15th
	day of the second month, Your total refund would be 50% of $385, or $192.50.
</p>

<p>

	A refund may be requested via email at refunds@bevomedia.com or via phone at 1-888-644-
	BEVO. PPV SPY and BEVO MEDIA RESERVES THE RIGHT, IN THEIR SOLE DISCRETION, TO CHANGE THE
	MEMBERSHIP FEES IN EFFECT, OR TO ADD NEW FEES AND/OR CHARGES, BY POSTING SUCH CHANGES
	ON THE WEBSITE OR OTHERWISE PROVIDING NOTICE TO YOU AS PROVIDED HEREIN.
</p>

<h3>Cardholder Terms:</h3>	
